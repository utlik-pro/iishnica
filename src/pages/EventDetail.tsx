...
const EventDetail = () => {
  ...
  const speakers = [
    {
      name: "Никита Карпук",
      topic: "HDR MCB Logistics",
      description: "Директор по развитию в группе компаний AAR и один из самых технологичных бизнес тренеров",
      avatar: "НК",
      image: "/nikitakarpuk.jpg"
    },
    {
      name: "Дима Утлик",
            ...
            <Card className="border border-purple-100 bg-white">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      {speakers.find(s => s.name === "Никита Карпук")?.image ? (
                        <img
                          src={speakers.find(s => s.name === "Никита Карпук")?.image}
                          alt="Никита Карпук"
                          className="h-12 w-12 rounded-full object-cover"
                        />
                      ) : (
                    ...
                    <h4 className="text-lg font-semibold text-primary mb-3">"ИИ-секреты топ-менеджеров"</h4>
                    <p className="text-muted-foreground mb-3">
                      А представьте: ваш конкурент тратит часы на анализ рынка, а вы — минуты. Информационный шум растет с каждым днем, а скорость принятия решений стала главным конкурентным преимуществом.
                    </p>
                    <p className="text-muted-foreground mb-3">
                      На митапе я расскажу о практическом применении Perplexity и Comet — инструментах, которые уже меняют правила игры в корпоративном управлении. Вы не просто узнаете о них теоретически — вы получите готовые сценарии для немедленного внедрения: от анализа новых рынков до мониторинга конкурентов за 5 минут.
                    </p>
                    <p className="text-muted-foreground">
                      И да, никакого сложного внедрения и огромного бюджета не потребуется. Первые решения — на митапе.
                    </p>
                  </div>
                </div>
              </CardContent>
